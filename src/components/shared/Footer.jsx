        ...
        <footer className="bg-base-200">
            <div className="max-w-7xl mx-auto py-5 md:py-8 lg:py-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 justify-center items-center *:flex *:flex-col *:mx-auto border-b border-b-white">
                <div className="text-center space-y-5">
                    <h3 className="text-xl md:text-2xl lg:text-3xl text-primary font-bold text-opacity-100 ">Contest<span className="text-secondary">Corner</span></h3>
                    <div>
            ...
            <div className="footer footer-center p-4">
                <aside>
                    <p className="text-sm md:text-lg">Copyright © 2024 - All right reserved by Contest Corner Co.</p>
                </aside>
            </div>
        </footer>
    );
