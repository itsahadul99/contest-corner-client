        ...
        <div className="min-h-[calc(100vh-380px)]">
            ...
            <Container>
                ...
                <div className="my-5 lg:my-8 px-2 py-1 md:px-5 md:py-2 bg-gray-100 w-fit mx-auto rounded-full">
                    ...
                    {
                        pageNumber.map((number, idx) => <button onClick ={() => setCurrentPage(number-1)} className={`${currentPage === number && 'bg-secondary'} btn border-none rounded-none`} key={idx}>{number + 1}</button>)
                    }
